# Generated by Django 3.1.1 on 2020-09-28 15:08
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=255,
                        verbose_name="Name for address type",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(
                        help_text="slug is human-readable, to make the referencing easier",
                        unique=True,
                        verbose_name="Slug",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=255, verbose_name="Name of county or state"
                    ),
                ),
                (
                    "abbreviation",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="eg. Company, Church, Association",
                        max_length=255,
                        verbose_name="Name for legal type",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default="",
                        help_text="abbreviation of the name, for quick search of persons",
                        max_length=255,
                ...
                (
                    "legacy_key",
                    models.CharField(
                        default="", max_length=255, verbose_name="Legacy Key"
                    ),
                ),
                (
                    "connect_key",
                    models.CharField(
                        default="",
                        help_text="This key can be communicated publically",
                        max_length=255,
                        verbose_name="Connect Key",
                    ),
                ),
                (
                    "salutation",
                    models.CharField(
                        help_text="eg. Frau, Firma",
                        max_length=255,
                        null=True,
                ...
                (
                    "salutation_letter",
                    models.CharField(
                        help_text="eg. Liebe Angela, Sehr geehrte Frau Graber, Liebe Freunde, Sehr geehrte Damen und Herren,",
                        max_length=255,
                        null=True,
                        verbose_name="Salutation Letter",
                    ),
                ),
                (
                    "preferred_language",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="eg. landline, mobile, fax, direct dial",
                        max_length=255,
                        verbose_name="Name for phone type",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=255, verbose_name="Name for relationship type"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "start_date",
                    models.DateField(blank=True, null=True, verbose_name="Starts on"),
                ),
                (
                    "end_date",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(default="", verbose_name="Supplemental Address"),
                ),
                ("postcode", models.TextField(default="", verbose_name="Post Code")),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="core_postal_status",
                        to="core.term",
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="core_phone_status",
                        to="core.term",
                    ),
                ),
                (
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                help_text="eg. active, died, inactive",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="core_email_status",
                        to="core.term",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "middle_name",
                    models.CharField(max_length=255, verbose_name="Middle Name"),
                ),
                (
                    "last_name",
                ...
                (
                    "gender",
                    models.ForeignKey(
                        help_text="eg. male, female, unknown",
                ...
                (
                    "title",
                    models.ForeignKey(
                        help_text="eg. Herr, Frau, Frau Dr.",
